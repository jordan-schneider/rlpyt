...
from rlpyt.models.qpg.mlp import PiMlpModel as PiMlpModel, QofMuMlpModel as QofMuMlpModel
...
class SacAgent(BaseAgent):
    min_itr_learn: int = ...
    def __init__(self, ModelCls: Any = ..., QModelCls: Any = ..., model_kwargs: Optional[Any] = ..., q_model_kwargs: Optional[Any] = ..., v_model_kwargs: Optional[Any] = ..., initial_model_state_dict: Optional[Any] = ..., action_squash: float = ..., pretrain_std: float = ...) -> None: ...
    ...
    def target_q(self, observation: Any, prev_action: Any, prev_reward: Any, action: Any): ...
