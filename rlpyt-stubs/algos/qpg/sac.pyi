...
OptInfo = namedtuple('OptInfo', ['q1Loss', 'q2Loss', 'piLoss', 'q1GradNorm', 'q2GradNorm', 'piGradNorm', 'q1', 'q2', 'piMu', 'piLogStd', 'qMeanDiff', 'alpha'])
SamplesToBuffer: Any
SamplesToBufferTl: Any

class SAC(RlAlgorithm):
    opt_info_fields: Any = ...
    def __init__(self, discount: float = ..., batch_size: int = ..., min_steps_learn: Any = ..., replay_size: Any = ..., replay_ratio: int = ..., target_update_tau: float = ..., target_update_interval: int = ..., learning_rate: float = ..., fixed_alpha: Optional[Any] = ..., OptimCls: Any = ..., optim_kwargs: Optional[Any] = ..., initial_optim_state_dict: Optional[Any] = ..., action_prior: str = ..., reward_scale: int = ..., target_entropy: str = ..., reparameterize: bool = ..., clip_grad_norm: float = ..., n_step_return: int = ..., updates_per_sync: int = ..., bootstrap_timelimit: bool = ..., ReplayBufferCls: Optional[Any] = ...) -> None: ...
    agent: Any = ...
    n_itr: Any = ...
    mid_batch_reset: Any = ...
    sampler_bs: Any = ...
